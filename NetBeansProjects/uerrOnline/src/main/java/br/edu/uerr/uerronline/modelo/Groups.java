...
@NamedQueries({
    ...
    , @NamedQuery(name = "Groups.findByCpfCandidato", query = "SELECT g FROM Groups g WHERE g.cpfCandidato = :cpfCandidato")
...
public class Groups implements Serializable {
    ...
    public Groups(Integer id, String cpfCandidato, String groupname) {
        this.id = id;
    ...
    public String toString() {
        return "br.edu.uerr.uerronline.modelo.Groups[ id=" + id + " ]";
    }
