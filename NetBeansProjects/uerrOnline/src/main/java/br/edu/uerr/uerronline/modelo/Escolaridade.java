...
@NamedQueries({
    ...
    , @NamedQuery(name = "Escolaridade.findByNivel", query = "SELECT e FROM Escolaridade e WHERE e.nivel = :nivel")})
public class Escolaridade implements Serializable {
    ...
    public String toString() {
        return "br.edu.uerr.uerronline.modelo.Escolaridade[ id=" + id + " ]";
    }
