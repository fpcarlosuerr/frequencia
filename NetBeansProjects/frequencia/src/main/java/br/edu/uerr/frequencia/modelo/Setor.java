...
@NamedQueries({
    ...
    , @NamedQuery(name = "Setor.findByDataRegistro", query = "SELECT s FROM Setor s WHERE s.dataRegistro = :dataRegistro")})
public class Setor implements Serializable {
    ...
    public String toString() {
        return "br.edu.uerr.frequencia.modelo.Setor[ id=" + id + " ]";
    }
